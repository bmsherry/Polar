export default class Snow {
  ...
  addObjs() {
    const texture = new THREE.TextureLoader().load('/three/images/noise.png');
  ...
  update() {
    ...
    // 性能监测插件
    this.stats.update();
    this.uniforms.u_time.value > 10000 ? this.uniforms.u_time.value = 0.0 : this.uniforms.u_time.value += delta * 0.5;
    // 渲染器执行渲染
